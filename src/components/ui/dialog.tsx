  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-[90vw] sm:w-full max-w-[90vw] sm:max-w-[calc(100vw-2rem)] max-h-[80vh] sm:max-h-[calc(100vh-2rem)] -translate-x-1/2 -translate-y-1/2 gap-3 sm:gap-4 rounded-lg border p-3 sm:p-6 shadow-lg duration-200 sm:max-w-lg overflow-hidden",
          className
        )}
        {...props}
      >
