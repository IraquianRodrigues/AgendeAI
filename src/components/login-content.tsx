...
export function LoginContent() {
  ...
  return (
    <div className="min-h-screen w-full flex">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative bg-gradient-to-br from-zinc-900 via-zinc-950 to-zinc-900 text-white flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-zinc-700/20 via-zinc-800/10 to-transparent rounded-full blur-[120px] animate-float"></div>
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-gradient-to-tr from-zinc-800/20 via-zinc-700/10 to-transparent rounded-full blur-[100px] animate-float-delayed"></div>
          <div className="absolute top-1/2 left-1/4 w-[400px] h-[400px] bg-gradient-to-br from-zinc-600/15 to-transparent rounded-full blur-[80px] animate-float-slow"></div>
          
          {/* Animated Particles */}
          <div className="absolute inset-0">
            <div className="absolute top-[20%] left-[10%] w-2 h-2 bg-zinc-400/40 rounded-full animate-particle-1"></div>
            <div className="absolute top-[60%] left-[30%] w-1.5 h-1.5 bg-zinc-500/30 rounded-full animate-particle-2"></div>
            <div className="absolute top-[40%] right-[20%] w-2 h-2 bg-zinc-400/40 rounded-full animate-particle-3"></div>
            <div className="absolute top-[80%] right-[40%] w-1 h-1 bg-zinc-300/50 rounded-full animate-particle-4"></div>
            <div className="absolute top-[30%] left-[60%] w-1.5 h-1.5 bg-zinc-400/35 rounded-full animate-particle-5"></div>
          </div>
          
          {/* Radial gradient overlay */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-zinc-700/10 via-transparent to-transparent"></div>
        </div>
        ...
        <div className="relative z-10 max-w-2xl space-y-8 mt-12 animate-fade-in-up animation-delay-200">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-800/50 border border-zinc-700/50 backdrop-blur-sm">
            ...
            <span className="text-sm text-zinc-300 font-medium">Sistema 100% em nuvem</span>
          </div>
        </div>
      ...
      <div className="w-full lg:w-[45%] flex items-center justify-center p-8 bg-white dark:bg-zinc-950 relative">
        ...
        <div className="w-full max-w-[400px] space-y-8 animate-fade-in-up animation-delay-100">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Mail className={`absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 transition-all duration-300 ${emailFocused ? 'text-zinc-600 scale-110' : 'text-gray-400'}`} />
                  <Input
                    id="email"
                    type="email"
                    ...
                    required
                    disabled={isLoading}
                    className={`pl-10 h-12 bg-gray-50 dark:bg-zinc-900 border-gray-200 dark:border-zinc-800 text-gray-900 dark:text-gray-100 transition-all duration-300 ${emailFocused ? 'ring-2 ring-zinc-500 border-zinc-500 shadow-lg shadow-zinc-500/20' : ''}`}
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Lock className={`absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 transition-all duration-300 ${passwordFocused ? 'text-zinc-600 scale-110' : 'text-gray-400'}`} />
                  <Input
                    id="password"
                    type="password"
                    placeholder="••••••••"
                    ...
                    required
                    disabled={isLoading}
                    className={`pl-10 h-12 bg-gray-50 dark:bg-zinc-900 border-gray-200 dark:border-zinc-800 text-gray-900 dark:text-gray-100 transition-all duration-300 ${passwordFocused ? 'ring-2 ring-zinc-500 border-zinc-500 shadow-lg shadow-zinc-500/20' : ''}`}
                  />
                </div>
              </div>
            </div>
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-foreground hover:bg-foreground/90 text-background font-semibold rounded-lg shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
              disabled={isLoading}
            >
              {isLoading ? (
