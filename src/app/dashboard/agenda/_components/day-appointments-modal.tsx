        ...
        <DialogContent className="max-w-2xl max-h-[90vh] p-0 flex flex-col">
          <DialogHeader className="px-4 sm:px-6 pt-4 sm:pt-6 pb-3 sm:pb-4 flex-shrink-0">
            <DialogTitle className="text-lg sm:text-xl md:text-2xl flex items-center gap-3">
              <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl p-2 flex items-center justify-center shadow-lg shadow-blue-500/20">
                    ...
                    <CardContent className="p-4 space-y-3">
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex items-center gap-2">
                          <div className="bg-blue-50 dark:bg-blue-950/20 text-blue-700 dark:text-blue-400 px-3 py-1.5 rounded-lg text-sm font-bold font-mono">
